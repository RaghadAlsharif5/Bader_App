                        ...
                        if( myData != null && myData.idForClubLead == null && Constants.userID != null )    
                          _buttonItem(
                              ...
                              onTap: ()
                              {
                                ...
                                {
                                  showToastMessage(context: context, message: "لقد تم إيقاف الإنضمام للنادي من قبل القائد ",backgroundColor: AppColors.kRedColor);
                                }
                                else
                                {
                                  showToastMessage(context: context, message: "في انتظار موافقة القائد لطلب العضويه");
                                }
                              }
                          )
                      ],
