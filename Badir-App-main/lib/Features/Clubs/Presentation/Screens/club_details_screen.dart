                    ...
                    _otherDetailsComponent(
                        ...
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ClubAchievementsScreen(
                                        club: club,
                                      )));
                        }),
                    _otherDetailsComponent(
                        ...
                        onTap: () {
                          ...
                          if (club.contactAccounts != null) {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        ViewClubContactMeansScreen(
                                            contactMeansForClub:
                                                club.contactAccounts!)));
                          } else {
                            showToastMessage(
                                context: context,
                                message: "لم يتم إضافة وسائل للتواصل حتى الان",
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Container(
                      ...
                      alignment: club.description != null
                      ...
                      child: Text(
                        club.description != null
                            ? club.description!
                            : "لم يتم اضافة وصف للنادي حتى الآن",
                        style: TextStyle(
                            fontSize: 13.sp,
