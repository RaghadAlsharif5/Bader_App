...
class ViewClubContactMeansScreen extends StatelessWidget {
  ...
  const ViewClubContactMeansScreen(
      {Key? key, required this.contactMeansForClub})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(
            title: const Text("وسائل التواصل للنادي"),
          ),
          body: Container(
            ...
            child: BlocListener<LayoutCubit, LayoutStates>(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "يمكنك التواصل مع النادي من خلال \n الحسابات التالية",
                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                          onTap: () {
                            layoutCubit.openPdf(
                                link: contactMeansForClub.email!);
                          },
                          child: Image.asset(
                      ...
                      InkWell(
                          onTap: () {
                            layoutCubit.openPdf(
                                link: contactMeansForClub.twitter!);
                          },
                          child: Image.asset(
