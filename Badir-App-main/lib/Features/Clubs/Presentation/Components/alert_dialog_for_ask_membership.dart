          ...
          child: AlertDialog(
              ...
              content: BlocBuilder<ClubsCubit, ClubsStates>(
                  buildWhen: (previousState, currentState) =>
                      currentState is CommitteeChosenSuccessState,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Center(
                            child: DefaultButton(
                              title:
                                  state is SendRequestForMembershipLoadingState
                                      ? "جاري ارسال الطلب"
                                      : 'إرسال',
                              roundedRectangleBorder: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(4)),
                              onTap: () {
                                if (cubit.selectedCommittee != null &&
                                    controller.text.isNotEmpty &&
                                    (club.availableOnlyForThisCollege.isEmpty ||
                                        (club.availableOnlyForThisCollege
                                                .isNotEmpty &&
                                            club.availableOnlyForThisCollege
                                                    .contains(
                                                        userEntity.college!) ==
                                                true))) {
                                  cubit.askForMembership(
                                      senderFirebaseFCMToken: userEntity
                                                  .firebaseMessagingToken !=
                                              null
                                          ? userEntity.firebaseMessagingToken!
                                          : null,
                                      userEntity: userEntity,
                                      committeeName: cubit.selectedCommittee!,
                                      clubID: club.id.toString(),
                                      infoAboutAsker: controller.text,
                                      userName: userEntity.name!);
                                } else if (cubit.selectedCommittee == null ||
                                    controller.text.isEmpty) {
                                  showToastMessage(
                                      context: context,
                                      message: "الرجاء ادخال المعلومات كاملة",
                                      backgroundColor: Colors.red);
                                } else if (club.availableOnlyForThisCollege
                                        .isNotEmpty &&
                                    club.availableOnlyForThisCollege
                                            .contains(userEntity.college!) ==
                                        false) {
                                  Navigator.pop(
                                  ...
                                  showToastMessage(
                                      context: context,
                                      message:
                                          "غير مصرح لك بالإنضمام نظرا لعدم توفر الشروط !!",
                                      backgroundColor: Colors.red);
                                }
                              },
                            ),
