...
class NotifyModel extends NotificationEntity {
  const NotifyModel(super.receiveDate, super.notifyType, super.fromAdmin,
      super.notifyMessage, super.clubID);

  factory NotifyModel.fromJson({required json}) {
    return NotifyModel(json['receiveDate'], json['notificationType'],
        json['fromAdmin'], json['notifyMessage'], json['clubID']);
  }
