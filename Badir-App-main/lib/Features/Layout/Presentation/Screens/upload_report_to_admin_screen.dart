      ...
      child: SafeArea(
        ...
        body: Padding(
          ...
          child: BlocConsumer<LayoutCubit, LayoutStates>(
            ...
            if (state is UploadReportToAdminLoadingState)
            ...
            return Column(
              ...
              children: [
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                                child: Text(
                              basename(layoutCubit.pdfFile!.path),
                ...
                DefaultButton(
                    ...
                    onTap: () {
                      if (layoutCubit.reportType != null &&
                          layoutCubit.pdfFile != null) {
                        layoutCubit.uploadReport(
                            clubName: club.name!,
                            senderID:
                                layoutCubit.userData!.id ?? Constants.userID!,
                            reportType: layoutCubit.reportType!,
