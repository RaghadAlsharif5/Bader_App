        ...
        child: Scaffold(
          ...
          body: BlocListener<EventsCubit, EventsStates>(
            listener: (context, state) {
              if (state is SendOpinionAboutEventLoadingState)
              ...
              if (state is SendOpinionAboutEventSuccessState) {
                ...
                Navigator.pop(context);
                showToastMessage(
                    context: context, message: 'تم إرسال رأيك بنجاح');
              }
            },
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    MaterialButton(
                      onPressed: () {
                        OpinionAboutEventModel opinion = OpinionAboutEventModel(
                            controller.text, userEntity.name!, eventName);
                        EventsCubit.getInstance(context).sendOpinionAboutEvent(
                            eventID: eventID,
