          ...
          body: Padding(
            ...
            child: BlocConsumer<EventsCubit, EventsStates>(
              ...
              if (state is CreateEventSuccessState) {
                ...
                showToastMessage(
                    context: context, message: "تم إنشاء الفعالية بنجاح");
              ...
              return Column(
                children: [
                  ...
                  DefaultButton(
                    ...
                    onTap: () {
                      if (cubit.eventImage == null) {
                        ...
                        cubit.createEvent(
                            ...
                            forPublic: cubit.eventForPublic,
                            ...
                            clubID:
                                clubsCubit.dataAboutClubYouLead!.id.toString(),
                    ...
                    title: state is CreateEventLoadingState
                        ? "جاري الإنشاء"
                        : "إنشاء",
                  )
                ],
