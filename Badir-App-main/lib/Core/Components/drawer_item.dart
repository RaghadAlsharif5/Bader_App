...
class DrawerItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (eventsCubit.ownEvents.isEmpty &&
        layoutCubit.userData != null &&
        layoutCubit.userData!.idForClubLead != null)
      eventsCubit.getPastAndNewAndMyEvents(
          idForClubILead: layoutCubit.userData!.idForClubLead);
    if (layoutCubit.userData!.idForClubLead != null &&
        clubsCubit.dataAboutClubYouLead == null)
      clubsCubit.getCLubDataThatILead(
          clubID: layoutCubit.userData!.idForClubLead!);
    return Drawer(
                      ...
                      currentAccountPicture: CircleAvatar(
                        backgroundColor:
                            layoutCubit.userData!.idForClubLead != null
                                ...
                                : Colors.transparent,
                        backgroundImage: layoutCubit.userData!.idForClubLead ==
                                null
                            ? AssetImage(
                                layoutCubit.userData!.gender == Constants.man
                                    ? "assets/images/man.png"
                                    : "assets/images/woman.png")
                            : null,
                        child: layoutCubit.userData!.idForClubLead != null
                            ? Image.asset(
                      ...
                      children: [
                        Expanded(
                          child: ListView.builder(
                              ...
                              itemCount: layoutCubit.userData!.idForClubLead !=
                                      null
                                  ? drawerData.length - 1
                                  : layoutCubit.userData!.idForClubsMemberIn !=
                                          null
                                      ? 5
                                      : 3,
                              itemBuilder: (context, index) {
                                return Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    trailing:
                                        Icon(drawerData[index]['iconData']),
                                  ),
                                );
                              }),
                        ),
