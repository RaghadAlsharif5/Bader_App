          ...
          child: Scaffold(
              appBar: AppBar(
                ...
                bottom: const TabBar(
                  tabs: [
                    Tab(
                      child: Text("الفعاليات الحديثة"),
                    ),
                    Tab(
                      child: Text("الفعاليات القديمة"),
                    ),
                  ],
                ),
              ),
                      ...
                      return TabBarView(
                        children: [
                          _displayEvents(
                              ...
                              context: context,
                              newEventsOrNot: true,
                              events: eventCubit.newEvents),
                          _displayEvents(
                              eventsCubit: eventCubit,
                              layoutCubit: layoutCubit,
                              userEntity: userEntity,
                              context: context,
                              newEventsOrNot: false,
                              events: eventCubit.pastEvents),
                        ],
                      );
                    }
                  })),
