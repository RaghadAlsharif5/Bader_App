...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (layoutCubit.userData == null && Constants.userID != null)
      layoutCubit.getMyData();
    ...
    if (clubsCubit.clubs.isEmpty)
      clubsCubit.getAllClubs(userEntity: layoutCubit.userData);
    return BlocBuilder<LayoutCubit, LayoutStates>(
        buildWhen: (pastState, currentState) =>
            currentState is GetMyDataSuccessState,
          ...
          return SafeArea(
            child: Directionality(
              ...
              child: BlocBuilder<ClubsCubit, ClubsStates>(
                  buildWhen: (pastState, currentState) =>
                      currentState is ChangeSearchAboutClubStatus,
                  builder: (context, state) {
                    return Scaffold(
                        drawer: Constants.userID != null ? DrawerItem() : null,
                        appBar: appBarForHomeScreen(
                            clubsCubit: clubsCubit, context: context),
                        body: Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal: 12.w, vertical: 7.5.h),
                            child: layoutCubit.userData != null ||
                                ...
                                ? ListView(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Expanded(
                                            child: BlocBuilder<ClubsCubit,
                                                ClubsStates>(
                                              buildWhen: (previousState,
                                                      currentState) =>
                                                  currentState
                                                      is GetClubsDataSuccessState &&
                                                  previousState != currentState,
                                              builder: (context, state) =>
                                                  StaticsDataWidget(
                                                      imagePath:
                                                          "assets/images/clubs_num_icon.png",
                                                      title: clubsCubit.clubs
                                                                  .length <=
                                                              10
                                                          ? "${clubsCubit.clubs.length} أندية"
                                                          : "${clubsCubit.clubs.length} نادي"),
                                            ),
                                          ),
                                          Expanded(
                                            child: Column(
                                                ...
                                                StreamBuilder(
                                                  stream: FirebaseFirestore
                                                      ...
                                                      .collection(Constants
                                                          .kTotalVolunteerHoursThrowAppCollectionName)
                                                      .doc('Number')
                                                      .snapshots(),
                                                  builder: (context, event) {
                                                    if (event.hasData) {
                                                      int volunteerHours = event
                                                                  .data!
                                                                  .data() !=
                                                              null
                                                          ? event.data!
                                          ...
                                          Expanded(
                                            child: Column(
                                              children: [
                                                Image.asset(
                                                  "assets/images/members_num_icon.png",
                                                  height: 70.h,
                                                  width: 70.w,
                                                ),
                                                SizedBox(
                                                ...
                                                StreamBuilder(
                                                  stream: FirebaseFirestore
                                                      .instance
                                                      .collection(Constants
                                                          .kMembersNumberCollectionName)
                                                      .doc('Number')
                                                      .snapshots(),
                                                  builder: (context, event) {
                                                    if (event.hasData) {
                                                      int membersNum = event
                                                                  .data!
                                                                  .data() !=
                                                              null
                                                          ? event.data!
                                      ...
                                      BlocBuilder<ClubsCubit, ClubsStates>(
                                          buildWhen: (previousState,
                                              ...
                                              currentState
                                                  is GetClubsDataSuccessState ||
                                              currentState
                                                  is GetFilteredClubsSuccessState,
                                          builder: (context, state) {
                                                    ...
                                                    child: ListView.separated(
                                                      ...
                                                      itemBuilder:
                                                        ...
                                                        return LayoutBuilder(
                                                          builder: (context,
                                                              constraints) {
                                                            return ClubItemOnHomeScreen(
                                                                context:
                                                                    context,
                                                                clubEntity: clubsCubit
                                                                        .filteredClubsData
                                                                        .isEmpty
                                                                    ? clubsCubit
                                                                            .clubs[
                                      ...
                                      BlocConsumer<EventsCubit, EventsStates>(
                                          buildWhen: (previousState,
                                                  currentState) =>
                                              currentState
                                                  is GetEventsDataSuccessState &&
                                              previousState != currentState,
                                          listener: (context, state) {
                                            if (state
                                                is JoinToEventLoadingState) {
                                              showLoadingDialog(
                                                  context: context);
                                            }
                                            if (state
                                                    is JoinToEventSuccessState ||
                                                state
                                                    is FailedToJoinToEventState) {
                                              Navigator.pop(
                                                  context); // TODO: Get out from Alert Dialog...
                                              showToastMessage(
                                                  context: context,
                                                  message: state
                                                          is FailedToJoinToEventState
                                                      ? state.message
                                                      : 'تم التسجيل بالفعالية بنجاح',
                                                ...
                                                ? SizedBox(
                                                    ...
                                                    child: ListView.separated(
                                                      ...
                                                      itemCount: eventsCubit
                                                          .allEvents
                                                          .length, // TODO: لان ما نبغى غير بالكثير هم عنصرين فقط
                                                      itemBuilder:
                                                          (context, index) {
                                                        return LayoutBuilder(
                                                          builder: (context,
                                                              constraints) {
                                                            // TODO: eventDate => لان محتاجين نعرف اذا الفعاليه عدت ولا لا
                                                            DateTime eventDate =
